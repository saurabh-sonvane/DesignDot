    ...
    <section className="w-full bg-[#0E3A8A] relative overflow-hidden">
      <div className="max-w-[1920px] mx-auto px-6 md:px-10 lg:px-16 py-12 lg:py-20">
        <div className="max-w-xl text-white z-10 relative">
          <p className="text-xs tracking-wide mb-4 opacity-80">
            ACCOUNTANTS AND GLOBAL BUSINESS ADVISORS
          </p>

          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold leading-[1.1]">
          ...
          <button className="mt-6 bg-orange-500 text-xs text-black pl-4 pr-8 px-6 py-3 rounded-md flex items-center justify-center font-bold gap-2 btn-path">
            <FaArrowRightLong />
            LET’S CONNECT
          </button>
      ...
      <div className="md:flex gap-2 absolute bottom-4 right-6  z-10">
        <div className="flex items-center">
          ...
          <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-white -ml-5">
            <Image
              src={user2}
              alt="user"
              className="object-cover w-full h-full"
        ...
        <div className="text-black lg:text-white font-bold ">
          ...
          <p className=" text-xs opacity-80 max-w-[80px]">Enjoy Working with us</p>
        </div>
      </div>
